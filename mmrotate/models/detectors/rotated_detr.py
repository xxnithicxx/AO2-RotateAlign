...
class RotatedDETR(RotatedSingleStageDetector):
    ...
    # Add params: gt_bboxes, gt_labels, gt_bboxes_ignore
    def simple_test(self, img, img_metas, rescale=False):
        cfg = self.test_cfg

        feat = self.extract_feat(img)
        # results_list = self.bbox_head.simple_test_bboxes(feat, img_metas, gt_bboxes, gt_labels, gt_bboxes_ignore, rescale=rescale)
