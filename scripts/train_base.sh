...
#SBATCH --output=out/train_baseline.out
#SBATCH --error=out/train_baseline.err
#SBATCH --nodes=1
...
python tools/train.py /media/lhbac13/AO2-FIX/configs/deformable_detr/base_unmodified.py --work-dir work_dirs/base_unmodified
